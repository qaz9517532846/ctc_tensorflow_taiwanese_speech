...
def run_ctc():
    ...
    with graph.as_default():
        ...
        conv3 = tf.contrib.layers.convolution1d(conv2, num_outputs = num_hidden, kernel_size=3, stride=1, activation_fn=None)
        ...
        outputs, _ = tf.nn.dynamic_rnn(stack, conv3, seq_len, dtype=tf.float32)
