...
def run_ctc():
    ...
    with graph.as_default():
        ...
        skip = tf.contrib.layers.convolution1d(inputs, num_outputs = num_hidden, kernel_size=3, stride=1, activation_fn=tf.nn.relu)
   
        hidden = tf.contrib.layers.convolution1d(skip, num_outputs = num_hidden, kernel_size=3, stride=1, activation_fn=tf.nn.relu)

        logits = tf.contrib.layers.convolution1d(hidden, num_outputs = num_hidden, kernel_size=3, stride=1, activation_fn=None)
