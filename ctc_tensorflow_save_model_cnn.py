...
def run_ctc():
    ...
    with graph.as_default():
        ...
        conv4 = tf.contrib.layers.convolution1d(conv3, num_outputs = num_hidden, kernel_size=3, stride=1, activation_fn=tf.nn.relu)

        conv5 = tf.contrib.layers.convolution1d(conv4, num_outputs = num_hidden, kernel_size=3, stride=1, activation_fn=None)

        logits = tf.transpose(conv5, (1, 0, 2), name = 'logits')
